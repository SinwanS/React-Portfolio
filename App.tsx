    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 selection:bg-purple-500/30">
      ...
      <nav className={`fixed w-full z-40 transition-all duration-300 px-6 py-4 ${scrolled ? 'glass py-3' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <a href="#" className="text-2xl font-black text-white tracking-tighter hover:text-purple-400 transition-colors">
            Sinwan<span className="text-purple-600">.</span>
          </a>
      ...
      <Section id="about" title="About Me" subtitle="A brief introduction of my professional journey and what drives me.">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-white">A short <span className="text-purple-400 italic font-serif">Intro</span></h3>
            <p className="text-lg text-slate-400 leading-relaxed">
              {PORTFOLIO_DATA.about}
            </p>
            <p className="text-lg text-slate-400 leading-relaxed">
              When I'm not coding, you'll find me in the gym or catching up on my steam or letterboxd backlog.
            </p>
            <div className="pt-4 flex gap-6">
              <div className="flex flex-col">
                <span className="text-purple-400 font-bold">Email</span>
                <span className="text-white">saeedsinwan@gmail.com</span>
              </div>
              <div className="flex flex-col">
                <span className="text-purple-400 font-bold">Location</span>
                <span className="text-white">Reisterstown, MD</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <Section id="contact" title="Connect" subtitle="Have a project in mind or just want to chat? Reach out!">
        <div className="glass p-12 rounded-[40px] border-purple-500/20 max-w-4xl mx-auto text-center">
          <h3 className="text-4xl font-bold text-white mb-8">Get in <span className="text-gradient">touch</span></h3>
          <div className="flex flex-wrap justify-center gap-6">
            <a href="mailto:saeedsinwan@gmail.com" className="flex items-center gap-3 px-8 py-4 bg-slate-800 rounded-2xl hover:bg-slate-700 transition-colors border border-slate-700">
            ...
            <a href="https://github.com/SinwanS" className="flex items-center gap-3 px-8 py-4 bg-slate-800 rounded-2xl hover:bg-slate-700 transition-colors border border-slate-700">
            ...
            <a href="https://www.linkedin.com/in/sinwan-saeed/" className="flex items-center gap-3 px-8 py-4 bg-slate-800 rounded-2xl hover:bg-slate-700 transition-colors border border-slate-700">
